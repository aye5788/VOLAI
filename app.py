...
# ------------------------------
# These should be set in your Streamlit secrets (secrets.toml)
# For example, your secrets.toml might contain:
# ORATS_TOKEN = "your_orats_token_here"
...
if st.button("Analyze Ticker"):
    ...
    if df_summaries.empty:
        ...
        if df_atm_grouped.empty:
            ...
            st.dataframe(df_atm_grouped[
                ["expiration", "strike", "callMidIv", "putMidIv", "delta", "gamma", "theta", "vega"]
            ])
